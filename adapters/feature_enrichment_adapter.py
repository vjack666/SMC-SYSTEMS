...
from detectors.displacement import detect_displacement, DisplacementConfig
from detectors.zones import compute_zones, ZoneConfig
from indicators import add_atr
from regime import detect_regimes, RegimeConfig
