...
def _synthetic_context() -> pd.DataFrame:
    ...
    df["swing_label"] = "NONE"
    df.loc[10, "swing_label"] = "HH"
    df.loc[20, "swing_label"] = "HH"
    df.loc[30, "swing_label"] = "LL"
    df.loc[40, "swing_label"] = "HH"
    df.loc[50, "swing_label"] = "HH"
    df["macro_direction"] = "BULLISH"
    df["d1_direction"] = "BULLISH"
    df["h4_trend"] = "BULLISH"
    df["trend_confidence"] = 0.6
    df["bos_direction"] = 1
    df.loc[:29, "bos_direction"] = 1
    df.loc[30:59, "bos_direction"] = -1
    df.loc[60:, "bos_direction"] = 1
    df["choch_signal"] = "NONE"
    df.loc[35, "choch_signal"] = "CHOCH_BEARISH"
