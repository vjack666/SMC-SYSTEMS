...
**Fecha de Actualización:** 2026-07-20 (cierre Fase 0 SPEC + 8 MDS + enmienda ARQUITECTURA_TEMPORALIDADES + propuesta Brecha A1 + REGLA DURA TZ: hora del servidor + conversión, bug KZ-2 detectado)
